...
<?php
    ...
    $tipo=$_GET["tipo"];
    $tipo2=$_GET["tipo2"];
    if($tipo>=5 and $tipo<=8){
        $query="select * from objetos where codigo=$tipo2";
    }
    else if($tipo>=9 and $tipo<=11){
        $query="select * from magias where codigo=$tipo2";
    }
    elseif($tipo>=13 and $tipo<=16){
        $query="select * from zona where codigo=$tipo2";
    }
    else{
        switch ($tipo){
